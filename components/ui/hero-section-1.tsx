                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=3276&h=4095&fit=crop&crop=center"
                                alt="background"
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing Football Analytics Platform</span>
                                    ...
                                    <p
                                        ...
                                        Discover player valuations, market trends, and performance analytics from the world's top football leagues. Make informed decisions with comprehensive data insights.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <Link href="/dashboard">
                                                <span className="text-nowrap">Explore Players</span>
                                            </Link>
                                        </Button>
                                    </div>
                                    <Button
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=2700&h=1440&fit=crop&crop=center"
                                    ...
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=2700&h=1440&fit=crop&crop=center"
                                        alt="Football analytics dashboard"
                                        width="2700"
                                        height="1440"
                                    />
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            <div className="flex">
                                <img
                                    ...
                                    src="https://logos-world.net/wp-content/uploads/2020/06/Premier-League-Logo.png"
                                    alt="Premier League"
                                    height="20"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    ...
                                    src="https://logos-world.net/wp-content/uploads/2020/06/La-Liga-Logo.png"
                                    alt="La Liga"
                                    height="16"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-4 w-fit dark:invert"
                                    src="https://logos-world.net/wp-content/uploads/2020/06/Serie-A-Logo.png"
                                    alt="Serie A"
                                    height="16"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-5 w-fit dark:invert"
                                    src="https://logos-world.net/wp-content/uploads/2020/06/Bundesliga-Logo.png"
                                    alt="Bundesliga"
                                    height="20"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-5 w-fit dark:invert"
                                    src="https://logos-world.net/wp-content/uploads/2020/06/Ligue-1-Logo.png"
                                    alt="Ligue 1"
                                    height="20"
                                    width="auto"
                                />
                            ...
                            <div className="flex">
                                <img
                                    ...
                                    src="https://logos-world.net/wp-content/uploads/2020/06/UEFA-Europa-League-Logo.png"
                                    alt="Europa League"
                                    height="28"
                                    width="auto"
                                />
